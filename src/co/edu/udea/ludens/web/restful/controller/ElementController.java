...
public class ElementController {
	...
	public  @ResponseBody List<Element> getPopulation(@PathVariable String  login) {
	...
	public  @ResponseBody MessageEvent upLevel(@PathVariable String  elementName, @PathVariable String login) {
		...
		elementName=URLDecoder.decode(elementName, ConstantsLudens.CHAR_SET);
    	...
    	Player player = playerService.findPlayer(login);
    	GameProcess gameProcess = (GameProcess) processHolderService.findProcessById(GameProcess.class, player.getGame().getName());
