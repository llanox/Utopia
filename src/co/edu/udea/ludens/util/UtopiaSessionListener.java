...
public class UtopiaSessionListener implements HttpSessionListener {
	...
	public void sessionDestroyed(HttpSessionEvent event) {
		...
		UserSessionBean userBean = (UserSessionBean) session.getAttribute(ConstantsLudens.SESSION_BEAN);
		SystemContainer systemContainer = (SystemContainer) session.getAttribute(ConstantsLudens.SYSTEM_CONTAINER_BEAN);
		User user=null;
