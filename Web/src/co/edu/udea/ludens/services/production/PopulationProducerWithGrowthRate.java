...
public class PopulationProducerWithGrowthRate implements ProducerStrategy {
	...
	public static final Logger logger = Logger.getLogger(PopulationProducerWithGrowthRate.class);
	...
	public List<ElementBean> produce(Object supplies,ElementProcess process) {
		...
		logger.info("P0 "+p0+" Old value "+population.getQuantity()+" Increment "+increment+"  "+population.getIncrementable().getName()+" result "+result);
