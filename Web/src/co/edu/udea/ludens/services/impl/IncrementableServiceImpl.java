...
public class IncrementableServiceImpl implements IncrementableService {
	...
	/**
	 * @param incrementableDao the incrementableDao to set
	 */
	...
	@Override
	public List<Incrementable> getAllIncrementablesGame(String gameName,EnumElementType material) {
		List<Incrementable> materials = incrementableDao.findAllByTypeAndGame(gameName,material);
		return materials;
	}
	...
	@Override
	public List<IncrementableConstraint> getAllConstraints(String gameName,String incrementableName) {
		
		return incrementableDao.findAllLevelConstraint(gameName, incrementableName);
	}
	...
	private boolean contains(List<IncrementableConstraint> constraints, Incrementable incr) {
	...
	public void setIncrementableConstraintDao(IncrementableConstraintDAO incrementableConstraintDao) {
